...
FAQ_CONTENT_TABLE = {
    ...
    "Le code de couleur est assez conventionnel. Jaune signifie que la date limite est proche (24h). Orange qu'elle est passée de moins de 5 secondes (délai de prise en compte de l'automate). Rouge qu'elle est passée de plus de 5 secondes. Rouge foncé que la grâce est aussi passée (en général 24 heures). La grace n'a aucune incidence sur le jeu hormis ce code de couleur et sert surtout à visualiser les parties qui stagnent. Pour les parties en direct c'est simplifié : rouge signifie que la date limite est passée, rien de plus. Soyez ponctuels !",
