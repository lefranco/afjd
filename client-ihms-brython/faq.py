...
FAQ_CONTENT_TABLE = {
    ...
    "Le code de couleur est assez conventionnel. Jaune signifie que la date limite est proche (24h). Or qu'elle est passée de moins de 5 secondes (délai de prise en compte de l'automate). Orange qu'elle est passée de plus de 5 secondes. Rouge que la grâce est aussi passée (en général 24 heures). Argent qu'elle est passée d'une semaine (partie bloquée). La grace n'a aucune incidence sur le jeu (mais entraine des plus grandes pénalités dans certains tournois). Pour les parties en direct c'est simplifié : rouge signifie que la date limite est passée, rien de plus. Soyez ponctuels !",
