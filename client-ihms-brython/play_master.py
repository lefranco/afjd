...
def game_master():
    ...
    def send_need_replacement_callback(ev, role_id):  # pylint: disable=invalid-name
        ...
        body += "\n"
        body += "Comment s'y prendre ? Aller sur le site, onglet 'Les parties', sous onglet 'Rejoindre une partie' et cliquez sur le bouton dans la colonne 'rejoindre' de la ligne de la partie en rose (Il peut être judicieux d'aller tâter un peu la partie au préalable)"
        body += "\n"
