...
def show_game_parameters():
    ...
    for key, value in game_parameters_loaded.items():
        ...
        parameter_name, explanation, effect, implemented = {
            'archive': ("archive", "la partie n'est pas jouée, elle est juste consultable", "L'arbitre peut passer des ordres, le système autorise les résolutions sans tenir compte des soumissions des joueurs", "OUI"),
