...
def show_game_parameters():
    ...
    for key, value in GAME_PARAMETERS_LOADED.items():
        ...
        parameter_name, explanation, effect, implemented = {
            ...
            'grace_duration': ("durée de la grâce", "en jours", "L'arbitre tolère un retard d'autant d'heures avant de placer des désordres civils", "OUI"),
            'speed_moves': ("vitesse pour les mouvements", "en jours", "Le système ajoute autant d'heures avant une résolution de mouvement pour une date limite", "OUI"),
            'speed_retreats': ("vitesse pour les retraites", "en jours", "Le système ajoute autant d'heures avant une résolution de retraites pour une date limite", "OUI"),
            'speed_adjustments': ("vitesse pour les ajustements", "en jours", "Le système ajoute autant d'heures avant une résolution d'ajustements pour une date limite", "OUI"),
