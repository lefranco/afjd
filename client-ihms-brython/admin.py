...
OPTIONS = ['changer nouvelles', 'usurper', 'rectifier la position', 'toutes les parties', 'dernières connexions', 'connexions manquées', 'e-mails non confirmés', 'envoyer un e-mail', 'récupérer un téléphone']
