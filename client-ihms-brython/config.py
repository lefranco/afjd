...
VARIANT_NAMES_LIST = ['standard', 'standard_pds', 'grandeguerre', 'hundred', 'moderne', 'egeemonie', 'mediterranee', 'successionautriche', 'franceautriche', 'crowded', 'coldwar', 'coldwar_redux']
