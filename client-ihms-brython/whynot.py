...
WHYNOT_CONTENT_TABLE = {
    ...
    "Cela nécessite une sorte de macanique infernale qui surveille les parties de manière périodique et déclenche des résolutions. Nous n'avons par encore d'idée précise sur comment la réaliser. Ou bien de donner à un joueur qui arrive sur la partie après la date limite la possibilté de déclencher cette résolution.",
