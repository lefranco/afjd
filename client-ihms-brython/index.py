...
OPTIONS = ['accueil', 'login', 'sélectionner partie', 'sélectionner interface', 'listes', 'mon compte', 'mes parties', 'éditer partie', 'appariement', 'jouer la partie', 'bac à sable', 'jouer contre l\'I.A.', 'coin technique', 'administration']
