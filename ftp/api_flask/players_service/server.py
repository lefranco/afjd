...
def suppress_account_message(pseudo: str) -> typing.Tuple[str, str]:
    ...
    body += "\n"
    body += "Tu ne t'es jamais inscrit dans aucune partie et le site est fait pour jouer."
    body += "\n"
    body += "Ou bien plusieurs comptes se ressemblent et ont le même courriel, dont le tien."
    body += "\n"
    ...
    body += "\n"
    body += "Nous serons ravis de jouer avec toi à ce jeu ou un de ses nombreuses variantes.."
    body += "\n"
    body += "Ludiquement"
    body += "\n"
    body += "================="
