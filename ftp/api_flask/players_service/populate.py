...
def populate_localizations(sql_executor: database.SqlExecutor) -> None:
    """ inserts these items in database """

    localizations.Localization.create_table(sql_executor)
...
def populate(sql_executor: database.SqlExecutor) -> None:
    ...
    populate_localizations(sql_executor)
