...
GAME_PARSER2.add_argument('soloed', type=int, required=False)
        ...
        if entered_deadline is not None:
            ...
            if entered_deadline == 0:  # this means "now, please !"
                ...
                if deadline_date < datetime.datetime.now(tz=datetime.timezone.utc):
                    ...
                    del sql_executor
                    flask_restful.abort(400, msg=f"You cannot set a deadline in the past from now!: '{date_desc} UTC'")
...
class GameStateListRessource(flask_restful.Resource):  # type: ignore
    ...
    def get(self, min_current_state: int, max_current_state: int) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        """
...
class AllocationStateListRessource(flask_restful.Resource):  # type: ignore
    ...
    def get(self, min_state: int, max_state: int) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        """
...
class GameRoleRessource(flask_restful.Resource):  # type: ignore
    ...
    def get(self, game_id: int) -> typing.Tuple[typing.Tuple[typing.Optional[int], bool], int]:
        """
...
class GamesCompleteOrReadyRessource(flask_restful.Resource):  # type: ignore
    ...
    def get(self, player_id: int) -> typing.Tuple[typing.Dict[str, typing.List[int]], int]:
        """
        ...
        # for these game we store the number of disorder (through variant)
        disorder_dict: typing.Dict[int, int] = {}
        for game_id in relevant_games:
            ...
            assert variant is not None
            nb_disorder = len(variant['disorder'])
            disorder_dict[int(game_id)] = nb_disorder
        ...
        # if game has disorder we need less people allocated
        ready_games = [tr[0] for tr in have_role_data if tr[0] in relevant_games and tr[1] - 1 < tr[2] - 1 - disorder_dict[tr[0]] and tr[0] in norole_dict and tr[1] - 1 + norole_dict[tr[0]] >= tr[2] - 1 - disorder_dict[tr[0]]]
...
@API.resource('/game-postpone-deadline/<game_id>')
class GamepostponeDeadlineRessource(flask_restful.Resource):  # type: ignore
    """ GamepostponeDeadlineRessource """
    ...
    def post(self, game_id: int) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        ...
        mylogger.LOGGER.info("/game-postpone-deadline/<game_id> - POST - postponing deadline (24h) game id=%s", game_id)
        ...
        data = {'msg': "Ok deadline postponed"}
        return data, 200
...
class GameDeclarationRessource(flask_restful.Resource):  # type: ignore
    ...
    def post(self, game_id: int) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        ...
        if announce:
            subject = f"Un modérateur du site a posté une déclaration (une annonce) dans la partie {game.name}"
        elif anonymous:
...
class GameMasterIncidentsRessource(flask_restful.Resource):  # type: ignore
    ...
    def get(self, game_id: int) -> typing.Tuple[typing.Dict[str, typing.List[typing.Tuple[int, int, int, int, float]]], int]:
        """
...
class GameCancelLastAdjudicationRessource(flask_restful.Resource):  # type: ignore
    ...
    def delete(self, game_id: int) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        """
...
class TournamentRessource(flask_restful.Resource):  # type: ignore
    ...
    def put(self, game_name: str) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        """
...
class TournamentIncidentsRessource(flask_restful.Resource):  # type: ignore
    ...
    def get(self, tournament_id: int) -> typing.Tuple[typing.List[typing.Tuple[int, int, int, int, float]], int]:
        ...
        mylogger.LOGGER.info("/tournament-incidents/<tournament_id> - GET - getting which incidents delay occured for tournament id=%s", tournament_id)
...
class TournamentIncidents2Ressource(flask_restful.Resource):  # type: ignore
    ...
    def get(self, tournament_id: int) -> typing.Tuple[typing.List[typing.Tuple[int, int, int, float]], int]:
        ...
        mylogger.LOGGER.info("/tournament-incidents2/<tournament_id> - GET - getting which incidents civil disorder occured for tournament id=%s", tournament_id)
...
@API.resource('/tournament-incidents3/<tournament_id>')
class TournamentIncidents3Ressource(flask_restful.Resource):  # type: ignore
    """ TournamentIncidents3Ressource """

    def get(self, tournament_id: int) -> typing.Tuple[typing.List[typing.Tuple[int, int, int, float]], int]:
        """
        Gets list of pseudo/alias which have produced an incident dropout for given tournament
        EXPOSED
        """

        mylogger.LOGGER.info("/tournament-incidents3/<tournament_id> - GET - getting which incidents civil disorder occured for tournament id=%s", tournament_id)
        ...
        late_list: typing.List[typing.Tuple[int, int, int, float]] = []
        for game_id in tournament_game_ids:
            incidents_list = dropouts.Dropout.list_by_game_id(sql_executor, game_id)
            for _, role_num, player_id, date_incident in incidents_list:
                late_list.append((game_id, role_num, player_id, date_incident))
...
class ExtractGamesDataRessource(flask_restful.Resource):  # type: ignore
    ...
    def get(self, type_: str) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        """
...
class AnnounceGamesTournamentRessource(flask_restful.Resource):  # type: ignore
    ...
    def post(self, tournament_id: int) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        """
        Insert declaration in database for all ongoing games of tournament
        EXPOSED
        """

        mylogger.LOGGER.info("/announce-games-tournament - POST - creating declaration in all ongoing games in tournament %d", tournament_id)
        ...
        for game_id in useful_games:
            ...
            subject = f"Le directeur du tournoi a posté une déclaration (une annonce) dans la partie {game.name} (ainsi que dans un ensemble de parties de sorte à atteindre tous les joueurs du tournoi dans des parties en cours)"
            allocations_list = allocations.Allocation.list_by_game_id(sql_executor, game_id)
            addressees = []
            for _, player_id, role_id1 in allocations_list:
                if role_id1 != role_id:
            ...
            body += f"Auteur de la déclaration dans le tournoi : {role_name}\n"
            body += "\n"
            body += "Contenu de la déclaration dans le tournoi :\n"
            body += "================\n"
            body += payload
            body += "\n"
            body += "================\n"
...
class AnnounceGamesSiteRessource(flask_restful.Resource):  # type: ignore
    ...
    def post(self) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        ...
        for game_id in useful_games:
            ...
            subject = f"Un modérateur du site a posté une déclaration sur le site (une annonce) dans la partie {game.name} (ainsi que dans un ensemble de parties de sorte à atteindre tous les joueurs des parties en cours)"
            allocations_list = allocations.Allocation.list_by_game_id(sql_executor, game_id)
            addressees = []
            for _, player_id, role_id1 in allocations_list:
                if role_id1 != role_id:
...
class ExtractComOrdersDataRessource(flask_restful.Resource):  # type: ignore
    ...
    def get(self) -> typing.Tuple[typing.Dict[int, typing.List[int]], int]:
        """
...
class ScoldLatePlayersGameRessource(flask_restful.Resource):  # type: ignore
    ...
    def post(self, game_id: int) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        ...
        if not missing_list:
            # This should not happen !
            del sql_executor
            flask_restful.abort(400, msg="There is no missing order")
        ...
        # build message
        subject = f"Vous êtes en retard dans la partie {game.name} !"
        game_id = game.identifier
        allocations_list = allocations.Allocation.list_by_game_id(sql_executor, game_id)
        addressees = []
        for _, player_id, role_id in allocations_list:
            ...
            if role_id in map(int, variant_data['disorder'].keys()):
                continue
            # only target thos whose orders are missing
            if role_id not in missing_list:
                continue
            addressees.append(player_id)
...
class DismissRessource(flask_restful.Resource):  # type: ignore
    ...
    def post(self, dismissed: str) -> typing.Tuple[typing.Dict[str, typing.Any], int]:
        """
        dismiss
        EXPOSED
        """
        ...
        sql_executor = database.SqlExecutor()
        allocations.Allocation.delete_by_player_id(sql_executor, dismissed_id)
        sql_executor.commit()
        del sql_executor
