...
def adjudicate(game_id: int, game: games.Game, variant_data: typing.Dict[str, typing.Any], names: str, sql_executor: database.SqlExecutor) -> typing.Tuple[bool, bool, str]:
    ...
    transition = transitions.Transition(int(game_id), game.current_advancement, time_stamp, position_transition_dict_json, orders_transition_dict_json, communication_orders_list_json, report_txt)
