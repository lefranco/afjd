...
def game_master(arrival):
    ...
    def show_choices_callback(ev):  # pylint: disable=invalid-name
        """ show_choices_callback """
    ...
    def send_need_replacement_callback(ev, role_id):  # pylint: disable=invalid-name
        ...
        body = "Bonjour !\n"
        body += "\n"
        body += "Cette partie a besoin d'un remplaçant. Vous avez demandé à être notifié dans un tel cas. Son arbitre vous sollicite !"
        body += "\n"
        ...
        body += "\n"
        body += "Héhé : il est intéressant de noter qu'un remplacement ne peut pas faire perdre de ELO (sauf si la partie n'a pas commencé auquel cas l'abandon du joueur doit être effacé).\n"
        body += "\n"
