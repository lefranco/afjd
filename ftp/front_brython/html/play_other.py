...
def show_informations():
    ...
    for key, value in play_low.GAME_PARAMETERS_LOADED.items():
        ...
        parameter_name, parameter_type, parameter_explanation = {
            ...
            'manual':                         ("attribution manuelle des rôles",                 "oui ou non", "Si oui, l'arbitre doit attribuer lui-même les roles, Le système ne réalise pas l'attribution des roles au démarrage de la partie"),  # noqa: E241
