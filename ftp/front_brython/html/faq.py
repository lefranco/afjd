...
FAQ_CONTENT_TABLE = {
    ...
    "Se connecter, sélectionner la partie comme d'habitude et se placer dans la console arbitrage (il faut être arbitre). Utiliser le bouton “Démarrer la partie“ (ou “Archiver la partie“) puis confirmer.",
