...
class Rating3:
    ...
    def update_database(self, sql_executor: database.SqlExecutor) -> None:
        ...
        sql_executor.execute("INSERT OR REPLACE INTO ratings3 (player_id, number_delays, number_dropouts, finished_playing_days, number_advancements) VALUES (?, ?, ?, ?, ?)", (self._player_id, self._number_delays, self._number_dropouts, self._finished_playing_days, self._number_advancements))
    ...
    def __str__(self) -> str:
        return f"player_id={self._player_id} number_delays={self._number_delays} number_dropouts={self._number_dropouts} finished_playing_days={self._finished_playing_days} number_advancements={self._number_advancements}"
